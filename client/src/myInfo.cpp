...
/*作者：卢虹羽
/***************************************************/
void on_sure_clicked (GtkWidget* button,gpointer data)
{
...
/***************************************************/
//获得性别
void on_check_sex(GtkWidget* radio,gpointer data)
{
...
/*作成日期：2019/9/1
/*参数：
        参数1：argc、int、输入参数、参数个数
        参数2：argv[]、char*、输入参数、参数列表
/*返回值：int 0,表示函数退出成功
/*作者：卢虹羽
/***************************************************/
void myInfo(int argc,char *argv[])
{
    GtkWidget *window;
    GtkWidget* box;
    GtkWidget* box1;
    ...
    change_background(window, 300, 500, "../source/skins/myself_background.jpg");
