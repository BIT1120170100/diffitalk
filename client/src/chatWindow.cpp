...
/*作者：卢虹羽
/***************************************************/
GtkWidget *create_button_expression(void) //expression
{
    GtkWidget *image;
    GtkWidget *button;
...
/*作者：卢虹羽
/***************************************************/
GtkWidget *create_button_image(void) //image
{
    GtkWidget *image;
    GtkWidget *button;
    GdkPixbuf *src_pixbuf;
...
/*作者：卢虹羽
/***************************************************/
GtkWidget *create_button_file(void) //files
{
    GtkWidget *image;
    GtkWidget *button;
    GdkPixbuf *src_pixbuf;
...
/*作者：卢虹羽
/***************************************************/
GtkWidget *create_button_history(void) //history
{
    GtkWidget *image;
    GtkWidget *button;
    GdkPixbuf *src_pixbuf;
...
/*作者：卢虹羽
/***************************************************/
void button_send_file(GtkWidget *button, gpointer userdata)
{
    GtkWidget *dialog;
...
void createChatWindow(GtkWidget *button_ori, gpointer *data)
{
    ...
    //设置窗口图片
    change_background(window, 600, 500, "../source/skins/chat_background_bule.jpg");//tongyi
